...
client.on("ready", () => {
  ...
  client.user.setActivity(`-new to open a ticket`);
});

const online = new Discord.RichEmbed()
      .setDescription("Bot Status")
      .setColor("#15f153")
      .addField("Bot is Online", "The bot has succesfully started.");


// displays console ready check
client.on('ready', () => {
  console.log('I am ready!');
  //sends announcement channel online message default off
  //client.channels.get(config.announcements).send(online)
});
